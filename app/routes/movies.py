...
from app.services.tmdb_service import fetch_movies, fetch_movie_details, fetch_movie_imdb_id, fetch_movie_videos, fetch_similar_movies
...
def movies_index():
    ...
    if profile.is_kids and not genre:
        genre = "10751,16"
